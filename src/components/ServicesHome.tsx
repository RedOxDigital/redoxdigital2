  ...
  const steps: ServiceStep[] = [
    {
      ...
      desc: 'You have a great offer, but nobody knows you exist. We help you get found on Google. We focus on real customers in North Lakes who are ready to buy, not just likes.',
