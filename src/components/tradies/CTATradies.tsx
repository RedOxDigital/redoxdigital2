      ...
      <div className="relative z-10 mx-auto max-w-[1600px] px-6 py-20 md:px-12 md:py-32">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            ...
            >
              Let us grab a coffee in North Lakes and look at your website together. We will show
              you exactly where you are losing leads and how tradies SEO can fix it. No pressure. No
              sales pitch. Just a straight conversation about your business.
            </motion.p>
            ...
            >
              <ContactButton variant="primary">Book a 15-Min Strategy Chat</ContactButton>
