    ...
    "@graph": [
      {
        ...
        "description": "We build the 6 page Sitelink Engine that doubles your Google Ad size. On site photo shoots, microsite builds, and job software integration for plumbers, electricians, and builders in North Lakes.",
        "provider": {
        ...
        "offers": {
          ...
          "price": "2500",
          "priceCurrency": "AUD",
          "description": "Complete Google Ads setup for tradies including site visit, 6 page microsite, ad restructure, and job software integration",
      ...
      },
      {
        ...
        "description": "Stop paying for invisible ads. We build the 6 page Sitelink Engine that doubles your Google Ad size for tradies in North Lakes and North Brisbane.",
        "isPartOf": {
